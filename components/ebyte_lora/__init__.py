...
async def to_code(config):
    ...
    cg.add(var.set_pin_aux(await cg.gpio_pin_expression(config[CONF_PIN_AUX])))
    cg.add(var.set_pin_m0(await cg.gpio_pin_expression(config[CONF_PIN_M0])))
    cg.add(var.set_pin_m1(await cg.gpio_pin_expression(config[CONF_PIN_M1])))
